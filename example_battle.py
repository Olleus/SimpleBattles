...
army_1.add(-2, archer).add(-1, archer).add(0, spear).add(1, spear).add(2, h_horse)

army_2 = Army("Persia", Stance.DEFN, "DarkRed")
army_2.add(-2, h_horse).add(-1, mixed).add(0, mixed).add(1, mixed).add(2, javelin)
